...
outputImage();
/**
 * Outputs a rectangle to the console.
 * @param x - The horizontal position within
 * the image.
 * @param y - The vertical position within
 * the image.
 * @param width - number of X characters to use for width
 * @param height - number of X characters to use for height
 */
...
/**
 * Outputs a horizontal line to the console.
 * @param x - The horizontal position within
 * the image.
 * @param y - The vertical position within
 * the image.
